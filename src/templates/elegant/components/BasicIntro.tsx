...
// 2. Updated Name to use titleColor
...
// 3. Updated Headline and separator bars to use titleColor
...
export default function BasicIntro({ basics }: { basics: IBasics }) {
  // 4. Access the global theme state
  const activeTheme = useThemes((state) => state.selectedTheme);

  return (
    <IntroContainer>
      {/* 5. Pass titleColor to the styled components */}

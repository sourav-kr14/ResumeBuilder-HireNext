...
const HomeLayout = () => {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="scroll-smooth bg-white">
      ...
      <nav className="sticky top-0 z-50 w-full bg-white border-b border-gray-100 backdrop-blur-xl bg-opacity-95">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link href="https://hirenext-alpha.vercel.app/all-jobs" className="text-gray-700 hover:text-indigo-600 font-medium transition">Find Jobs</Link>
            <Link href="https://hirenext-alpha.vercel.app/companies" className="text-gray-700 hover:text-indigo-600 font-medium transition">Companies</Link>
            <Link href="/builder" className="text-gray-700 hover:text-indigo-600 font-medium transition">Resume Builder</Link>
          </div>

          <div className="flex items-center space-x-4">
            <Link href="/login">
              <Button variant="outlined" className="border-gray-300 text-gray-700 hover:border-indigo-600">
                Login
              </Button>
            </Link>
            <Link href="/builder">
              <Button variant="contained" className="bg-gradient-to-r from-indigo-600 to-purple-600 shadow-lg hover:shadow-xl">
                Build Free
              </Button>
            </Link>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div {...fadeUp} className="space-y-8">
              ...
              <p className="text-xl text-gray-600 max-w-2xl">
                Trusted by candidates at top companies. ATS-friendly templates. 10,000+ people got their dream job using HireNext.
              </p>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="text-center mb-16">
      <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
        Why 5 Million+ Indians Choose <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">HireNext</span>
      </h2>
      <p className="mt-4 text-xl text-gray-600">Everything you need to get hired faster</p>
    </div>
    <div className="grid md:grid-cols-3 gap-8">
      {[
        { icon: "🚀", title: "ATS-Optimized Resumes", desc: "Beat 99% of applicant tracking systems used by Google, Amazon, Deloitte" },
        { icon: "✨", title: "1-Click Apply", desc: "Apply to 100+ jobs in seconds with pre-filled details" },
        { icon: "⭐", title: "Expert Reviewed Templates", desc: "Designed by recruiters from FAANG & top Indian startups" },
        { icon: "📈", title: "300% More Interview Calls", desc: "Users report 3x higher response rate within 7 days" },
        { icon: "🆓", title: "100% Free Forever", desc: "No hidden charges. No credit card. Unlimited downloads" },
        { icon: "🔒", title: "100% Private & Secure", desc: "Your data is encrypted. We never sell or share it" }
      ].map((feature, i) => (
        <motion.div
          key={i}
...
<section className="py-20 bg-white">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    ...
    <p className="text-xl text-gray-600 mb-12">Freshers • Experienced • Designers • Managers • Tech • Non-Tech</p>
    
    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
      {["/template1.jpg", "/template2.jpg", "/template3.jpg", "/template4.jpg"].map((src, i) => (
        <motion.div
          key={i}
    ...
    <Link href="/builder">
      <Button size="large" variant="contained" className="mt-12 bg-gradient-to-r from-indigo-600 to-purple-600 px-12 py-4 text-lg font-bold">
...
<section className="py-20 bg-gradient-to-r from-indigo-50 to-purple-50">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid md:grid-cols-3 gap-8">
      {[
        { name: "Priya Sharma", role: "SDE-1 at Google", prev: "Tier-3 College", img: "/person1.jpg", story: "Got 7 offers including Google & Microsoft after using HireNext template" },
        { name: "Rahul Verma", role: "Product Manager at Flipkart", prev: "0 Experience", img: "/person2.jpg", story: "Landed PM role with 28 LPA within 21 days of building resume" },
        { name: "Anjali Mehta", role: "UX Designer at Swiggy", prev: "Career Gap 2 Years", img: "/person3.jpg", story: "Returned to work with 42% salary hike using designer template" }
      ].map((person, i) => (
        <motion.div
          key={i}
...
<section className="py-20 bg-white">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    ...
    <div className="grid md:grid-cols-3 gap-12">
      {[
        { step: "1", title: "Choose Template", desc: "Pick from 50+ ATS-friendly designs", icon: "🎨" },
        { step: "2", title: "Fill Your Details", desc: "Auto-suggestions & smart content tips", icon: "✍️" },
        { step: "3", title: "Download & Apply", desc: "Get PDF in 1 click. Start applying instantly", icon: "🚀" }
      ].map((item, i) => (
        <div key={i}>
...
<section className="py-24 bg-gradient-to-r from-indigo-600 to-purple-700">
  <div className="max-w-4xl mx-auto text-center px-6">
    ...
    <div className="flex flex-col sm:flex-row gap-6 justify-center">
      <Link href="/builder">
        <Button size="large" variant="contained" className="bg-white text-indigo-600 hover:bg-gray-100 px-12 py-5 text-xl font-bold shadow-2xl">
          ⚡ Build My Resume Free
        </Button>
      </Link>
      <Link href="https://hirenext-alpha.vercel.app/all-jobs">
        <Button size="large" variant="outlined" className="border-white text-white hover:bg-white/10 px-12 py-5 text-xl font-bold">
          Browse 50,000+ Jobs
        </Button>
      </Link>
    </div>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
      ...
      <div className="space-y-5">
        <div className="flex items-center space-x-3">
          <Image src="/hero.jpg" alt="HireNext" width={42} height={42} className="rounded-lg" />
          <span className="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
            HireNext
          </span>
        </div>
        <p className="text-gray-600 text-sm leading-relaxed">
          India's most trusted resume builder & job platform. 
          Used by <strong>5M+ professionals</strong> to land jobs at top companies.
        </p>
        <div className="flex space-x-4">
          ...
          <a href="#" className="text-gray-500 hover:text-indigo-600 transition">LinkedIn</a>
          <a href="#" className="text-gray-500 hover:text-indigo-600 transition">Twitter</a>
        </div>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-3 text-gray-600">
          <li><Link href="/all-jobs" className="hover:text-indigo-600 transition">Browse Jobs</Link></li>
          <li><Link href="/companies" className="hover:text-indigo-600 transition">Top Companies</Link></li>
          <li><Link href="/builder" className="hover:text-indigo-600 transition">Resume Builder</Link></li>
          <li><Link href="/salary-insights" className="hover:text-indigo-600 transition">Salary Insights</Link></li>
          <li><Link href="/interview-prep" className="hover:text-indigo-600 transition">Interview Prep</Link></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-3 text-gray-600">
          ...
          <li><Link href="/search-resumes" className="hover:text-indigo-600 transition">Search Resumes</Link></li>
          <li><Link href="/pricing" className="hover:text-indigo-600 transition">Pricing Plans</Link></li>
          <li><Link href="/employer-branding" className="hover:text-indigo-600 transition">Employer Branding</Link></li>
        </ul>
      </div>
    ...
    <div className="border-t border-gray-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
      ...
      <div className="flex space-x-6 mt-4 md:mt-0">
        <span className="flex items-center"><span className="text-green-600 mr-1">✓</span> ATS Friendly</span>
        <span className="flex items-center"><span className="text-indigo-600 mr-1">✓</span> 100% Free Resume Builder</span>
        <span className="flex items-center"><span className="text-purple-600 mr-1">✓</span> Trusted by 5M+ Users</span>
      </div>
    </div>
  </div>
</footer>
